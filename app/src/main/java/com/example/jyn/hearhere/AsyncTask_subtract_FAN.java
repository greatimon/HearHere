...
/**
 * Created by JYN on 2017-07-26.
 */

public class AsyncTask_subtract_FAN extends AsyncTask<String, Void, String> {

    private String SERVER_URL_SUBTRACT_FAN = Static.SERVER_URL_SUBTRACT_FAN;
    private String my_user_no;
    private String clicked_user_no;

    AsyncTask_subtract_FAN() {}
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            URL url = new URL(SERVER_URL_SUBTRACT_FAN);
