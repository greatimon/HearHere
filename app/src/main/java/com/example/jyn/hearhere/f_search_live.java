...
public class f_search_live extends Fragment {
    ...
    public f_search_live() {
        // Required empty public constructor
    }

    public static f_search_live newInstance() {
        Bundle args = new Bundle();

        f_search_live fragment = new f_search_live();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // 프레그먼트 인플레이팅
        layout = (LinearLayout)inflater.inflate(R.layout.f_search_live, container, false);
        ...
        recyclerAdapter = new RecyclerAdapter(getActivity(), a_search.roomList_aryLi, R.layout.i_room_list, "live");
        ...
        if(a_search.searched_before) {
            ...
            if(a_search.roomList_aryLi.size() > 0) {
